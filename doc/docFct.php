...
$fichierDesFonctions = "../fct.php"    ;
$fichierDesExemples  = "fctEx.xmp" ;
...
$titre1 = "Les $nbFns fonctions de fct.php" ;
$titre2 = "&nbsp; &nbsp; Les $nbFns fonctions de ".s_span("fct.php","grouge") ;
...
input_select("lafns","size=\"20\"") ;
  foreach ($tdfns as $nfns) {
    $selected = "" ;
    $plus     = " ondblclick='window.location.replace(\"docFct.php?lafns=$nfns\")' " ;
    if ($nfns==$lafnsel) {
      $selected = "selected" ;
    } ; # fin si
...
if ($lafns!="") {
  ...
  textarea("","cadre",15,100,"corps") ;
    echo "\n" ;
    texteDeLaFonction($lafns,"../fct.php") ;
  fintextarea() ;
  finp() ;
} else {

  h2("&nbsp; Texte intégral de fct.php") ;
  pvide() ;
  #blockquote() ;
  p("ptextarea") ;
  textarea_fichier("","cadre",24,100,"docFct","../fct.php") ;
  finp() ;
  #finblockquote() ;
